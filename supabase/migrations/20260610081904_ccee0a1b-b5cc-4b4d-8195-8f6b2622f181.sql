...
grant execute on function public.upload_leaderboard_time_with_device_token(text, text, text, text, text, text, integer, timestamptz) to anon;
grant execute on function public.upload_leaderboard_time_with_device_token(text, text, text, text, text, text, integer, timestamptz) to authenticated;
grant execute on function public.upload_leaderboard_time_with_device_token(text, text, text, text, text, text, integer, timestamptz) to service_role;